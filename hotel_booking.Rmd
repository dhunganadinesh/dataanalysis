...
**Plot displaying 2 hotel, City and Resort Hotel, number of guest with and without children through out the year. The data from 3 years is combined according to the month and displayed in the graph below.**
```{r}
hotel_stayed %>% 
  mutate(arrival_date_month = factor(arrival_date_month, levels = month.name)) %>% 
...
**Creating plot for car parking spaces required for hotel bookings. Displaying 2 hotel, City and Resort Hotel, guest requesting car park whith children and without children.**
```{r}
